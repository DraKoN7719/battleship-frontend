...
const ShipList = ({shipList, setSelectedShip, setCoordinates, coordinates, setShipList}) => {
    ...
    return (
        <div>
            ...
            {(shipList.filter(x => x.count === 0)).length  === 4 ? <Link  to="/battleTheComputer" state={coordinates} className='button_battle'>В бой</Link> :
